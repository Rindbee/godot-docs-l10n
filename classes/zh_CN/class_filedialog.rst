...
.. XML source: https://github.com/godotengine/godot/tree/4.4/doc/classes/FileDialog.xml.
...
\ **注意：**\ 在 Android 上只有使用 :ref:`ACCESS_FILESYSTEM<class_FileDialog_constant_ACCESS_FILESYSTEM>` 时才支持。使用 :ref:`ACCESS_RESOURCES<class_FileDialog_constant_ACCESS_RESOURCES>`\ 、\ :ref:`ACCESS_USERDATA<class_FileDialog_constant_ACCESS_USERDATA>` 等访问模式时系统会回退至自定义 FileDialog。
