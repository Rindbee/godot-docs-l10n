...
.. XML source: https://github.com/godotengine/godot/tree/4.4/doc/classes/PackedColorArray.xml.
...
返回数组中位于给定索引 ``index`` 处的 :ref:`Color<class_Color>`\ 。与使用 ``[]`` 运算符相同（\ ``array[index]``\ ）。
