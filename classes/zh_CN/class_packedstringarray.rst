...
.. XML source: https://github.com/godotengine/godot/tree/4.4/doc/classes/PackedStringArray.xml.
...
返回数组中位于给定索引 ``index`` 处的 :ref:`String<class_String>`\ 。与使用 ``[]`` 运算符相同（\ ``array[index]``\ ）。
