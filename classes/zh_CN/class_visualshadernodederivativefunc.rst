...
.. XML source: https://github.com/godotengine/godot/tree/4.4/doc/classes/VisualShaderNodeDerivativeFunc.xml.
...
设置用于导数函数的精度级别。可选项见 :ref:`Precision<enum_VisualShaderNodeDerivativeFunc_Precision>`\ 。使用 Compatibility 渲染器时此设置无效。
