...
.. XML source: https://github.com/godotengine/godot/tree/4.4/doc/classes/CPUParticles2D.xml.
...
返回给定粒子标志的启用状态（选项见 :ref:`ParticleFlags<enum_CPUParticles2D_ParticleFlags>`\ ）。
