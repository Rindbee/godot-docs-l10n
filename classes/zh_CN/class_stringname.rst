...
.. XML source: https://github.com/godotengine/godot/tree/4.4/doc/classes/StringName.xml.
...
将该字符串从 URL 编码格式中解码。该方法的目的是在收到 HTTP 请求时正确解码 URL 中的参数。另见 :ref:`uri_encode()<class_StringName_method_uri_encode>`\ 。
