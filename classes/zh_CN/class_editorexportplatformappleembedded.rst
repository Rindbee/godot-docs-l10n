...
**派生：** :ref:`EditorExportPlatformIOS<class_EditorExportPlatformIOS>`, :ref:`EditorExportPlatformVisionOS<class_EditorExportPlatformVisionOS>`

Apple 嵌入式平台导出器的基类（iOS 与 visionOS）。
...
Apple 嵌入式平台导出器的基类。包括 iOS 和 visionOS，但是不包括 macOS。详见派生类。
