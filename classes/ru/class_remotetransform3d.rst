...
RemoteTransform3D помещает свой собственный :ref:`Transform3D<class_Transform3D>` в другой производный узел :ref:`Node3D<class_Node3D>` в сцене.
...
RemoteTransform3D помещает свой собственный :ref:`Transform3D<class_Transform3D>` в другой производный узел :ref:`Node3D<class_Node3D>` (называемый удаленным узлом) в сцене.
...
:ref:`NodePath<class_NodePath>` к удаленному узлу относительно положения RemoteTransform3D на сцене.
...
**RemoteTransform3D** кэширует удаленный узел. Он может не заметить, если удаленный узел исчезнет; :ref:`force_update_cache()<class_RemoteTransform3D_method_force_update_cache>` заставляет его обновить кэш снова.
