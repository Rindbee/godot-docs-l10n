...
Узел, позволяющий перенаправить соединение в графе визуального шейдера.
...
Автоматически адаптирует тип порта к типу входящего соединения и обеспечивает допустимые соединения.
...
Возвращает тип порта узла перенаправления.
