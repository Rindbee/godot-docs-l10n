...
:ref:`Cubemap<class_Cubemap>` без данных изображения.
...
Этот класс заменяет :ref:`Cubemap<class_Cubemap>` или производный от :ref:`Cubemap<class_Cubemap>` класс в 2 условиях:
...
- Когда производный от :ref:`Cubemap<class_Cubemap>` класс отсутствует, например, при использовании другой версии движка.
