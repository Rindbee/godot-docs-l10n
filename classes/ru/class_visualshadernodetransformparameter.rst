...
Параметр :ref:`Transform3D<class_Transform3D>` для использования в графе визуального шейдера.
...
Переведено в ``uniform mat4`` на языке шейдеров.
...
Позволяет использовать :ref:`default_value<class_VisualShaderNodeTransformParameter_property_default_value>`.
