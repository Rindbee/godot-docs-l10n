...
Вариант :ref:`BoxContainer<class_BoxContainer>`, который может размещать дочерние элементы управления только вертикально. Дочерние элементы управления автоматически перестраиваются при изменении их минимального размера.
