...
Переопределяемая версия внутреннего метода ``shape_collide`` :ref:`PhysicsServer2D<class_PhysicsServer2D>`. Соответствует :ref:`PhysicsDirectSpaceState2D.collide_shape()<class_PhysicsDirectSpaceState2D_method_collide_shape>`.
