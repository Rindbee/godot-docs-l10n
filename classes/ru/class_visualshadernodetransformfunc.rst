...
Вычисляет функцию :ref:`Transform3D<class_Transform3D>` в графе визуального шейдера.
...
Вычисляет обратную или транспонированную функцию для предоставленного :ref:`Transform3D<class_Transform3D>`.
...
Выполнить обратную инверсивную операцию над матрицей :ref:`Transform3D<class_Transform3D>`.
...
Выполнить операцию транспонирования матрицы :ref:`Transform3D<class_Transform3D>`.
...
Представляет размер перечисления :ref:`Function<enum_VisualShaderNodeTransformFunc_Function>`.
...
Функция, которую необходимо вычислить.
