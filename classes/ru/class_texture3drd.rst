...
Этот класс текстуры позволяет использовать 3D-текстуру, созданную непосредственно на :ref:`RenderingDevice<class_RenderingDevice>`, в качестве текстуры для материалов, сеток и т. д.
