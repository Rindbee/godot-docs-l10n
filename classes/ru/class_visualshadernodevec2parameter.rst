...
Параметр :ref:`Vector2<class_Vector2>` для использования в графе визуального шейдера.
...
Переведено в ``uniform vec2`` на языке шейдеров.
...
Позволяет использовать :ref:`default_value<class_VisualShaderNodeVec2Parameter_property_default_value>`.
