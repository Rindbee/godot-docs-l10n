...
Представляет собой движения осей (например, джойстика или аналоговых триггеров) с геймпада.
...
Сохраняет информацию о движениях джойстика. Один **InputEventJoypadMotion** представляет одну ось за раз. Для кнопок геймпада см. :ref:`InputEventJoypadButton<class_InputEventJoypadButton>`.
...
Текущее положение джойстика на данной оси. Значение находится в диапазоне от ``-1.0`` до ``1.0``. Значение ``0`` означает, что ось находится в состоянии покоя.
