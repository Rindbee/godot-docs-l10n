...
Полезно для воспроизведения частиц, если используется в сочетании с :ref:`use_fixed_seed<class_GPUParticles2D_property_use_fixed_seed>` или путем вызова :ref:`restart()<class_GPUParticles2D_method_restart>` с параметром ``keep_seed``, установленным на ``true``.
