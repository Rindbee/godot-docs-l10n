...
Текстура с 3 измерениями, опционально сжатая.
...
**CompressedTexture3D** — это сжатый VRAM аналог :ref:`ImageTexture3D<class_ImageTexture3D>`. Расширение файла для файлов **CompressedTexture3D** — ``.ctex3d``. Этот формат файла является внутренним для Godot; он создается путем импорта других форматов изображений с помощью системы импорта.
...
См. :ref:`Texture3D<class_Texture3D>` для общего описания 3D-текстур.
...
Путь к файлу **CompressedTexture3D** к файлу ``.ctex3d``.
