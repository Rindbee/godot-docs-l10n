...
Элемент управления для отображения простого текста. Он дает вам контроль над горизонтальным и вертикальным выравниванием и может обтекать текст внутри ограничивающего прямоугольника узла. Он не поддерживает полужирный шрифт, курсив или другое расширенное форматирование текста. Для этого используйте :ref:`RichTextLabel<class_RichTextLabel>`.
