...
Форма 2D сегмента двухмерной линии, используемая для физического столкновения.
...
Форма сегмента 2D-линии, предназначенная для использования в физике. Обычно используется для предоставления формы для :ref:`CollisionShape2D<class_CollisionShape2D>`.
...
Положение второй точки сегмента.
