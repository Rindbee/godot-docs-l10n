...
Закрывает свет, отбрасываемый Light2D, отбрасывая тени. LightOccluder2D должен быть снабжен :ref:`OccluderPolygon2D<class_OccluderPolygon2D>` для вычисления тени.
...
:ref:`OccluderPolygon2D<class_OccluderPolygon2D>` используется для вычисления тени.
