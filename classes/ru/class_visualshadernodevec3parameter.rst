...
Параметр :ref:`Vector3<class_Vector3>`, который будет использоваться в графе визуального шейдера.
...
Переведено в ``uniform vec3`` на языке шейдеров.
...
Позволяет использовать :ref:`default_value<class_VisualShaderNodeVec3Parameter_property_default_value>`.
