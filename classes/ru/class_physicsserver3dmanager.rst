...
Синглтон для управления реализациями :ref:`PhysicsServer3D<class_PhysicsServer3D>`.
...
**PhysicsServer3DManager** — это API для регистрации реализаций :ref:`PhysicsServer3D<class_PhysicsServer3D>` и для установки реализации по умолчанию.
...
Зарегистрируйте реализацию :ref:`PhysicsServer3D<class_PhysicsServer3D>`, передав ``name`` и :ref:`Callable<class_Callable>`, который возвращает объект :ref:`PhysicsServer3D<class_PhysicsServer3D>`.
...
Установите реализацию :ref:`PhysicsServer3D<class_PhysicsServer3D>` по умолчанию на ту, которая определена ``name``, если ``priority`` больше приоритета текущей реализации по умолчанию.
