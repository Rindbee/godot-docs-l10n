...
Описывает сопоставление названий костей для перенацеливания :ref:`Skeleton3D<class_Skeleton3D>` на общие названия, определяемые :ref:`SkeletonProfile<class_SkeletonProfile>`.
...
Этот класс содержит словарь, который использует список имен костей в :ref:`SkeletonProfile<class_SkeletonProfile>` в качестве имен ключей.

Назначая фактическое имя кости :ref:`Skeleton3D<class_Skeleton3D>` в качестве значения ключа, он сопоставляет :ref:`Skeleton3D<class_Skeleton3D>` с :ref:`SkeletonProfile<class_SkeletonProfile>`.
...
:ref:`SkeletonProfile<class_SkeletonProfile>` цели отображения. Ключевые имена в **BoneMap** синхронизированы с ним.
...
Возвращает имя кости профиля, имеющее ``skeleton_bone_name``. Если не найдено, будет возвращено пустое :ref:`StringName<class_StringName>`.
