...
**Popup** — базовый класс для контекстных окон и панелей с фиксированным положением. Он модальный по умолчанию (см. :ref:`Window.popup_window<class_Window_property_popup_window>`) и предоставляет методы для реализации пользовательского поведения всплывающих окон.
