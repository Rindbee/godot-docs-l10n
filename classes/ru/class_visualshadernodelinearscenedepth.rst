...
Узел визуального шейдера, который возвращает значение глубины узла DEPTH_TEXTURE в линейном пространстве.
...
Этот узел можно использовать во фрагментных шейдерах.
