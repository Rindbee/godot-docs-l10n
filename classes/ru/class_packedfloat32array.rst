...
Возвращает 32-битное число с плавающей точкой по указанному ``index`` в массиве. Если ``index`` выходит за пределы или отрицателен, этот метод завершается ошибкой и возвращает ``0.0``. 
