...
Вид текстуры (используется :ref:`RenderingDevice<class_RenderingDevice>`).
...
Необязательное переопределение формата данных для возврата выборочных значений. Соответствующий :ref:`RDTextureFormat<class_RDTextureFormat>` должен иметь это добавленным как общий формат. Значение по умолчанию :ref:`RenderingDevice.DATA_FORMAT_MAX<class_RenderingDevice_constant_DATA_FORMAT_MAX>` не переопределяет формат.
...
Канал для выборки при выборке альфа-канала.
...
Канал для выборки при выборке канала синего цвета.
...
Канал для выборки при выборке канала зеленого цвета.
...
Канал для выборки при выборке канала красного цвета.
