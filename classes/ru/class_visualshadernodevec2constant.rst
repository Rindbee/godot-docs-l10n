...
Константа :ref:`Vector2<class_Vector2>`, которая будет использоваться в графе визуального шейдера.
...
Константа :ref:`Vector2<class_Vector2>`, которую можно использовать в качестве входного узла.
...
Константа :ref:`Vector2<class_Vector2>`, которая представляет состояние этого узла.
