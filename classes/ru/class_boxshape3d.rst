...
Трехмерная форма куба, используемая для физического столкновения.
...
Форма 3D-коробки, предназначенная для использования в физике. Обычно используется для предоставления формы для :ref:`CollisionShape3D<class_CollisionShape3D>`.

\ **Производительность:** **BoxShape3D** быстро проверяет столкновения. Он быстрее, чем :ref:`CapsuleShape3D<class_CapsuleShape3D>` и :ref:`CylinderShape3D<class_CylinderShape3D>`, но медленнее, чем :ref:`SphereShape3D<class_SphereShape3D>`.
