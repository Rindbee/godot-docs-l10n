...
Возвращает :ref:`Vector3<class_Vector3>` по указанному ``index`` в массиве. Если ``index`` выходит за пределы или отрицателен, этот метод завершается ошибкой и возвращает ``Vector3(0, 0, 0)``.
