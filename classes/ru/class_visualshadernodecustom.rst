...
Переопределите этот метод, чтобы включить высокоуровневую отметку в диалоговом окне членов редактора визуальных шейдеров.

Определение этого метода **необязательно**. Если не переопределено, то ``false``.
