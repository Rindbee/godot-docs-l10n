...
Выполняет объединенную операцию умножения-сложения в графе визуального шейдера.
...
Использует три операнда для вычисления выражения ``(a * b + c)``.
...
Представляет размер перечисления :ref:`OpType<enum_VisualShaderNodeMultiplyAdd_OpType>`.
