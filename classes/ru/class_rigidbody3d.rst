...
См. :ref:`freeze_mode<class_RigidBody3D_property_freeze_mode>`, чтобы задать поведение тела при заморозке.

Для тела, которое всегда заморожено, используйте :ref:`StaticBody3D<class_StaticBody3D>` или :ref:`AnimatableBody3D<class_AnimatableBody3D>`.
...
Режим заморозки тела. Может использоваться для настройки поведения тела, когда включено :ref:`freeze<class_RigidBody3D_property_freeze>`.
