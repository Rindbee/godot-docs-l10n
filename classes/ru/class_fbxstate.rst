...
**Наследует:** :ref:`GLTFState<class_GLTFState>` **<** :ref:`Resource<class_Resource>` **<** :ref:`RefCounted<class_RefCounted>` **<** :ref:`Object<class_Object>`
...
FBXState обрабатывает данные о состоянии, импортированные из файлов FBX.
...
Если ``true``, процесс импорта использовал вспомогательные узлы, называемые узлами-помощниками геометрии. Эти узлы помогают сохранить повороты и преобразования исходной 3D-модели во время импорта.
