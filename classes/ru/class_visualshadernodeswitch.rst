...
Функция выбора для использования в графе визуального шейдера.
...
Возвращает связанное значение типа :ref:`op_type<class_VisualShaderNodeSwitch_property_op_type>`, если предоставленное логическое значение равно ``true`` или ``false``.
...
Представляет размер перечисления :ref:`OpType<enum_VisualShaderNodeSwitch_OpType>`.
