...
Это абстрактный класс. Смотрите производные типы для описания возможных значений.
