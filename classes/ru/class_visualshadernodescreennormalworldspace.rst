...
Узел визуального шейдера, который распаковывает текстуру нормали экрана в мировом пространстве (World Space).
...
Узел ScreenNormalWorldSpace позволяет создавать эффекты контура.
