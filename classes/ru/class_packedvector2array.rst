...
Возвращает :ref:`Vector2<class_Vector2>` по указанному ``index`` в массиве. Если ``index`` выходит за границы или отрицателен, этот метод завершается ошибкой и возвращает ``Vector2(0, 0)``.
