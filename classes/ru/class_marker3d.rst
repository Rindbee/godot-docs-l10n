...
Общая подсказка по положению в 3D для редактирования.
...
Общая подсказка положения 3D для редактирования. Это как обычный :ref:`Node3D<class_Node3D>`, но он всегда отображается в виде крестика в 3D-редакторе.
