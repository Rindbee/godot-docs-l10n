...
Менеджер кэша буфера кадров для рендереров на основе устройств рендеринга. Предоставляет способ создания буфера кадров и его повторного использования в последующих вызовах до тех пор, пока существуют используемые текстуры. Буферы кадров будут автоматически очищаться при освобождении зависимых объектов.
