...
Узел визуального шейдера, создающий испускаемые частицы в форме кольца.
...
:ref:`VisualShaderNodeParticleEmitter<class_VisualShaderNodeParticleEmitter>`, который заставляет частицы испускаться в форме кольца с заданными внутренним и внешним радиусами и высотой.
