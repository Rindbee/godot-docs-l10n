...
Перечисленное значение для необязательной оси вращения. См. также :ref:`set_joint_rotation_axis_vector()<class_SpringBoneSimulator3D_method_set_joint_rotation_axis_vector>`.
...
Возвращает направление хвоста конечной кости цепочки костей, когда :ref:`is_end_bone_extended()<class_SpringBoneSimulator3D_method_is_end_bone_extended>` равен ``true``.
...
Возвращает длину хвоста конечной кости цепочки костей, когда :ref:`is_end_bone_extended()<class_SpringBoneSimulator3D_method_is_end_bone_extended>` равен ``true``.
...
Если :ref:`get_joint_rotation_axis()<class_SpringBoneSimulator3D_method_get_joint_rotation_axis>` равен :ref:`ROTATION_AXIS_ALL<class_SpringBoneSimulator3D_constant_ROTATION_AXIS_ALL>`, этот метод возвращает ``Vector3(0, 0, 0)``.
...
Если :ref:`get_rotation_axis()<class_SpringBoneSimulator3D_method_get_rotation_axis>` равен :ref:`ROTATION_AXIS_ALL<class_SpringBoneSimulator3D_constant_ROTATION_AXIS_ALL>`, этот метод возвращает ``Vector3(0, 0, 0)``.
...
Устанавливает ось вращения в ``joint`` в списке суставов цепочки костей, когда :ref:`is_config_individual()<class_SpringBoneSimulator3D_method_is_config_individual>` равен ``true``.

Оси основаны на пространстве :ref:`Skeleton3D.get_bone_rest()<class_Skeleton3D_method_get_bone_rest>`, если ``axis`` равен :ref:`ROTATION_AXIS_CUSTOM<class_SpringBoneSimulator3D_constant_ROTATION_AXIS_CUSTOM>`, вы можете указать любую ось.
...
Если длина вектора равна ``0``, он считается синонимом :ref:`ROTATION_AXIS_ALL<class_SpringBoneSimulator3D_constant_ROTATION_AXIS_ALL>`.
...
Оси основаны на пространстве :ref:`Skeleton3D.get_bone_rest()<class_Skeleton3D_method_get_bone_rest>`, если ``axis`` — это :ref:`ROTATION_AXIS_CUSTOM<class_SpringBoneSimulator3D_constant_ROTATION_AXIS_CUSTOM>`, вы можете указать любую ось.
