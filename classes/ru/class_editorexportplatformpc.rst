...
**Наследуется от:** :ref:`EditorExportPlatformLinuxBSD<class_EditorExportPlatformLinuxBSD>`, :ref:`EditorExportPlatformWindows<class_EditorExportPlatformWindows>`
...
Базовый класс для экспортеров настольных платформ. К ним относятся Windows и Linux/BSD, но не macOS. Подробнее см. классы, наследуемые от этого.
