...
:ref:`Shape3D<class_Shape3D>` — это :ref:`WorldBoundaryShape3D<class_WorldBoundaryShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`SeparationRayShape3D<class_SeparationRayShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`SphereShape3D<class_SphereShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`BoxShape3D<class_BoxShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`CapsuleShape3D<class_CapsuleShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`CylinderShape3D<class_CylinderShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`ConvexPolygonShape3D<class_ConvexPolygonShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`ConcavePolygonShape3D<class_ConcavePolygonShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` — это :ref:`HeightMapShape3D<class_HeightMapShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` используется внутри для создания мягкого тела. Любая попытка создать подобную фигуру приводит к ошибке.
...
Устанавливает данные формы, определяющие ее форму и размер. Передаваемые данные зависят от типа созданной формы :ref:`shape_get_type()<class_PhysicsServer3D_method_shape_get_type>`.
