...
Константа :ref:`Transform3D<class_Transform3D>` для использования в графе визуального шейдера.
...
Константа :ref:`Transform3D<class_Transform3D>`, которую можно использовать в качестве входного узла.
...
Константа :ref:`Transform3D<class_Transform3D>`, которая представляет состояние этого узла.
