...
Массив исходной текстуры. Используется, если :ref:`VisualShaderNodeSample3D.source<class_VisualShaderNodeSample3D_property_source>` установлен в :ref:`VisualShaderNodeSample3D.SOURCE_TEXTURE<class_VisualShaderNodeSample3D_constant_SOURCE_TEXTURE>`.
