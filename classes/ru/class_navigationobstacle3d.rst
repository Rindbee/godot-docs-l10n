...
С :ref:`Avoidance_enabled<class_NavigationObstacle3D_property_Avoidance_enabled>` препятствие может ограничивать скорости избегания агентов избегания. Если вершины препятствия закручены по часовой стрелке, агенты избегания будут выталкиваться препятствием, в противном случае агенты избегания будут выталкиваться. Препятствия, использующие вершины и избегание, могут деформироваться в новое положение, но не должны перемещаться в каждом кадре, поскольку каждое изменение требует перестройки карты избегания.
