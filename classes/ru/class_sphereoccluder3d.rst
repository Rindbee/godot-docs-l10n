...
Сферическая форма для использования с отсечением окклюзии в :ref:`OccluderInstance3D<class_OccluderInstance3D>`.
...
**SphereOccluder3D** хранит сферическую форму, которая может быть использована системой отсечения окклюзии движка.

См. документацию :ref:`OccluderInstance3D<class_OccluderInstance3D>` для инструкций по настройке отсечения окклюзии.
