...
Состояние смешивания цветов конвейера (используется :ref:`RenderingDevice<class_RenderingDevice>`).
...
Константа цвета для смешивания. См. также :ref:`RenderingDevice.draw_list_set_blend_constants()<class_RenderingDevice_method_draw_list_set_blend_constants>`.
...
Если ``true``, выполняет логическую операцию, определенную в :ref:`logic_op<class_RDPipelineColorBlendState_property_logic_op>`.
...
Логическая операция для выполнения смешивания. Действует только если :ref:`enable_logic_op<class_RDPipelineColorBlendState_property_enable_logic_op>` равен ``true``.
