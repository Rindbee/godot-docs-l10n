...
Трехмерная форма столкновения частиц в форме коробки, влияющая на узлы :ref:`GPUParticles3D<class_GPUParticles3D>`.
...
Форма столкновения частиц в форме коробки, влияющая на узлы :ref:`GPUParticles3D<class_GPUParticles3D>`.
...
Размер области столкновения в трехмерных единицах.
