...
Элемент GUI , отображающий :ref:`StyleBox<class_StyleBox>`.
...
**Panel** — это элемент управления GUI, отображающий :ref:`StyleBox<class_StyleBox>`. См. также :ref:`PanelContainer<class_PanelContainer>`.
...
- `Демонстрация иерархического конечного автомата <https://godotengine.org/asset-library/asset/2714>`__
...
:ref:`StyleBox<class_StyleBox>` этого элемента управления.
