...
Слой композиции OpenXR, отображаемый как четырехугольник.
...
Слой композиции OpenXR, позволяющий визуализировать :ref:`SubViewport<class_SubViewport>` на четырехугольнике.
...
Размеры квадроцикла (четырехугольника).
