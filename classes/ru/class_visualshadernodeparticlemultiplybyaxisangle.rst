...
Вспомогательный узел визуального шейдера для умножения положения и вращения частиц.
...
Этот узел помогает умножить вектор входного положения на вращение с использованием определенной оси. Предназначен для работы с излучателями.
...
Если ``true``, угол будет интерпретироваться в градусах, а не в радианах.
