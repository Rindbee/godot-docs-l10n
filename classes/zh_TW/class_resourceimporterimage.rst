...
此匯入器匯入 :ref:`Image<class_Image>` 資源，而不是 :ref:`CompressedTexture2D<class_CompressedTexture2D>`\ 。如果需要以 2D 或 3D 形式算繪圖像，請改用 :ref:`ResourceImporterTexture<class_ResourceImporterTexture>`\ 。
