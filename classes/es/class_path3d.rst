...
El color personalizado que se usará para dibujar la forma en el editor.

Si se establece en ``Color(0.0, 0.0, 0.0)`` (por defecto), se usa el color definido en EditorSettings.
