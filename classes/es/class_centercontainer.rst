...
Un contenedor que mantiene los controles hijos en su centro.
...
**CenterContainer** es un contenedor que mantiene todos sus controles hijos en su centro en su tamaño mínimo.
...
Si es ``true``, centra a los hijos en relación con la esquina superior izquierda del **CenterContainer**.
