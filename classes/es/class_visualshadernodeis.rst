...
Comparación con ``NaN`` (No es un número; indica resultados numéricos no válidos, como la división por cero).
...
Representa el tamaño del enum :ref:`Function<enum_VisualShaderNodeIs_Function>`.
