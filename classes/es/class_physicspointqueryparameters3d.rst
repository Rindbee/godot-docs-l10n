...
Al cambiar varias propiedades de este objeto, como la posición del punto, puedes configurar los parámetros para :ref:`PhysicsDirectSpaceState3D.intersect_point()<class_PhysicsDirectSpaceState3D_method_intersect_point>`.
