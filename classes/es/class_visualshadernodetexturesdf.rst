...
Realiza una búsqueda de textura SDF (campo de distancia con signo) dentro del gráfico del shader visual.
...
Se traduce como ``texture_sdf(sdf_pos)`` en el lenguaje del shader.
