...
Realiza una búsqueda de texturas 3D dentro del gráfico de shader visual.
...
Una textura de origen. Se usa si :ref:`VisualShaderNodeSample3D.source<class_VisualShaderNodeSample3D_property_source>` está establecido a :ref:`VisualShaderNodeSample3D.SOURCE_TEXTURE<class_VisualShaderNodeSample3D_constant_SOURCE_TEXTURE>`.
