...
Un parámetro :ref:`Vector3<class_Vector3>` que se utilizará dentro del gráfico de shader visual.
...
Habilita el uso de :ref:`default_value<class_VisualShaderNodeVec3Parameter_property_default_value>`.
