...
Devuelve la normal de colisión del suelo en el último punto de colisión. Sólo es válido después de llamar a :ref:`move_and_slide()<class_CharacterBody3D_method_move_and_slide>` y cuando :ref:`is_on_floor()<class_CharacterBody3D_method_is_on_floor>` devuelve ``true``.
