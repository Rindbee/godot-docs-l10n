...
Calcula una función :ref:`Transform3D<class_Transform3D>` dentro del grafo de shader visual.
...
Calcula una función inversa o de transposición en la :ref:`Transform3D<class_Transform3D>` proporcionada.
...
Realiza la operación inversa en la matriz :ref:`Transform3D<class_Transform3D>`.
...
Realiza la operación de transposición en la matriz :ref:`Transform3D<class_Transform3D>`.
...
Representa el tamaño del enum :ref:`Function<enum_VisualShaderNodeTransformFunc_Function>`.
