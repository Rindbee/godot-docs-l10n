...
Un nodo de shader visual que devuelve el valor de profundidad del nodo DEPTH_TEXTURE en un espacio lineal.
...
Este nodo se puede utilizar en shaders de fragmento.
