...
Exportar configuración preestablecida.
...
Devuelve filtros de archivos para excluir durante el cifrado PCK.
...
Devuelve filtros de archivos para incluir durante el cifrado PCK.
...
Devuelve la clave de cifrado PCK.
...
Devuelve filtros de archivos para excluir durante la exportación.
...
Devuelve la ruta de destino de la exportación.
...
Devuelve el modo de exportación de archivo para el archivo especificado.
...
Devuelve un array de archivos para exportar.
...
Devuelve filtros de archivos para incluir durante la exportación.
...
Devuelve la lista de paquetes en los que basar una exportación de parche.
...
Devuelve ``true`` si el ajuste preestablecido tiene la propiedad denominada ``property``.
