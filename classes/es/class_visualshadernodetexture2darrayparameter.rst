...
Un nodo de shader visual para el parámetro de shader (uniform) de tipo :ref:`Texture2DArray<class_Texture2DArray>`.
...
Este parámetro permite proporcionar una colección de texturas para el shader. Puedes usar :ref:`VisualShaderNodeTexture2DArray<class_VisualShaderNodeTexture2DArray>` para extraer las texturas del array.
