...
Un nodo de animación de escala de tiempo utilizado en :ref:`AnimationTree<class_AnimationTree>`.
...
Permite ajustar la velocidad de la animación (o invertirla) en cualquier :ref:`AnimationNode<class_AnimationNode>` secundario. Al establecerlo en ``0.0``, la animación se pausará.
