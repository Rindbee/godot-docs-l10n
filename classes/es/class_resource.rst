...
Duplica este recurso, profundamente, como :ref:`duplicate()<class_Resource_method_duplicate>`\ ``(true)``, con un control adicional sobre cómo se manejan los subrecursos.

\ ``deep_subresources_mode`` debe ser uno de los valores de :ref:`DeepDuplicateMode<enum_Resource_DeepDuplicateMode>`.
