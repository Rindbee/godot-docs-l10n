...
Un parámetro :ref:`Transform3D<class_Transform3D>` para usar dentro del gráfico de shader visual.
...
Habilita el uso de :ref:`default_value<class_VisualShaderNodeTransformParameter_property_default_value>`.
