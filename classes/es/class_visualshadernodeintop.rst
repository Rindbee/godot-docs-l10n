...
Un operador escalar entero para ser usado dentro del grafo de shader visual.
...
Aplica :ref:`operator<class_VisualShaderNodeIntOp_property_operator>` a dos entradas enteras: ``a`` y ``b``.
...
Representa el tamaño del enum :ref:`Operator<enum_VisualShaderNodeIntOp_Operator>`.
