...
Un parámetro :ref:`Color<class_Color>` para ser usado dentro del gráfico de shader visual.
...
Habilita el uso de :ref:`default_value<class_VisualShaderNodeColorParameter_property_default_value>`.
