...
\ **Nota:** Quando si utilizza un :ref:`Viewport<class_Viewport>` con :ref:`Viewport.use_hdr_2d<class_Viewport_property_use_hdr_2d>` impostato su ``true``, la texture restituita sarà un'immagine HDR codificata nello spazio lineare. Potrebbe apparire più scura del normale se visualizzata direttamente sullo schermo. Per convertire nello spazio gamma, puoi fare quanto segue:
