...
Una costante di tipo :ref:`Vector3<class_Vector3>` da utilizzare all'interno del grafico di visual shader.
...
Una costante di tipo :ref:`Vector3<class_Vector3>`, che può essere utilizzata come nodo in ingresso.
...
Una costante di tipo :ref:`Vector3<class_Vector3>` che rappresenta lo stato di questo nodo.
