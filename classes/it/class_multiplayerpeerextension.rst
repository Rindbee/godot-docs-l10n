...
Chiamato quando un pacchetto deve essere inviato tramite la :ref:`MultiplayerAPI<class_MultiplayerAPI>`, dove ``p_buffer_size`` è la dimensione del ``p_buffer`` binario in byte.
