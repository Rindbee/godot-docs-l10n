...
Allarga la linea del collegamento quando il mouse ci passa sopra di un fattore in percentuale. Un valore di ``0`` disattiva l'evidenziazione. Un valore di ``100`` raddoppia lo spessore della linea.
