...
Questa classe rappresenta la connessione WebSocket e può essere utilizzata come client WebSocket (conforme a RFC 6455) o come peer remoto di un server WebSocket.
