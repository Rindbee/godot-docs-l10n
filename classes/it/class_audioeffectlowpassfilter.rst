...
Aggiunge un filtro passa-basso al bus audio.
...
Taglia le frequenze più alte di :ref:`AudioEffectFilter.cutoff_hz<class_AudioEffectFilter_property_cutoff_hz>` e permette alle frequenze più basse di passare.
