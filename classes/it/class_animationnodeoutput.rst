...
Il nodo di animazione in uscita di un :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>`.
...
Un nodo creato automaticamente in un :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>` che produce l'animazione finale.
