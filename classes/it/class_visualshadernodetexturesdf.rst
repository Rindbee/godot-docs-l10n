...
Esegue una ricerca di texture SDF (signed-distance field) all'interno del grafico di visual shader.
...
Tradotto come ``texture_sdf(sdf_pos)`` nel linguaggio di shader.
