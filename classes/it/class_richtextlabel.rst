...
Se questo bit è impostato, :ref:`update_image()<class_RichTextLabel_method_update_image>` modifica le percentuali di larghezza da/a dell'immagine.
...
Se ``true``, la dimensione minima dell'etichetta sarà automaticamente aggiornata per adattarsi al suo contenuto, corrispondente al comportamento di :ref:`Label<class_Label>`.
