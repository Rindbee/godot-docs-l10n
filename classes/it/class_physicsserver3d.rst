...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`WorldBoundaryShape3D<class_WorldBoundaryShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`SeparationRayShape3D<class_SeparationRayShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`SphereShape3D<class_SphereShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`BoxShape3D<class_BoxShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`CapsuleShape3D<class_CapsuleShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`CylinderShape3D<class_CylinderShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`ConvexPolygonShape3D<class_ConvexPolygonShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`ConcavePolygonShape3D<class_ConcavePolygonShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è un :ref:`HeightMapShape3D<class_HeightMapShape3D>`.
...
Lo :ref:`Shape3D<class_Shape3D>` è utilizzato internamente per un corpo morbido. Ogni tentativo di creare questo tipo di forma genera un errore.
...
Restituisce i dati della forma.
...
Imposta i dati di forma che definiscono la sua forma e dimensione. I dati da passare dipendono dal tipo di forma creata :ref:`shape_get_type()<class_PhysicsServer3D_method_shape_get_type>`.
