...
Aggiunge un filtro a pendenza per alti al bus audio.
...
Riduce tutte le frequenze al di sopra di :ref:`AudioEffectFilter.cutoff_hz<class_AudioEffectFilter_property_cutoff_hz>`.
