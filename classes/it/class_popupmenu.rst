...
Emesso quando viene premuto un elemento con un certo ``id`` o viene attivato il suo acceleratore.
...
Emesso quando viene premuto un elemento con l'indice ``index`` o viene attivato il suo acceleratore.
...
Imposta il tempo di ritardo in secondi per la comparsa di un elemento di sottomenu al passaggio del mouse. Se il menu popup viene aggiunto come figlio di un altro (agendo come sottomenu), erediterà il tempo di ritardo di un elemento di menu genitore.
