...
Indica se è possibile eseguire questo importatore in parallelo sui thread o, al contrario, è sicuro per l'editor chiamarlo solo dal thread principale, per un file alla volta.

Se questo metodo non viene sovrascritto, restituirà ``false`` come predefinito.
