...
Il ``callback`` deve accettare un singolo argomento di tipo :ref:`StringName<class_StringName>` che conterrà il nome del tipo dell'oggetto selezionato o sarà vuoto se non è selezionato alcun elemento.
