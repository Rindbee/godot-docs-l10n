...
Aggiunge un filtro a pendenza per bassi al bus audio.
...
Riduce tutte le frequenze al di sotto di :ref:`AudioEffectFilter.cutoff_hz<class_AudioEffectFilter_property_cutoff_hz>`.
