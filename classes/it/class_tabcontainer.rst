...
La posizione della barra di schede.
...
Il colore del font della scheda al passaggio del mouse.
...
L'icona visualizzata per indicare dove sarà rilasciata una scheda trascinata (vedi :ref:`drag_to_rearrange_enabled<class_TabContainer_property_drag_to_rearrange_enabled>`).
