...
**Успадковує:** :ref:`GLTFState<class_GLTFState>` **<** :ref:`Resource<class_Resource>` **<** :ref:`RefCounted<class_RefCounted>` **<** :ref:`Object<class_Object>`
...
FBXState керує державними даними, імпортованими з файлів FBX.
...
Якщо ``true``, процес імпортування використовується допоміжні вузли, які називають вузлами керма геометрії. Ці вершини допомагають зберегти опори і трансформації оригінальної моделі 3D при імпорті.
