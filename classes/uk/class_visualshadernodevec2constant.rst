...
:ref:`Vector2<class_Vector2>` постійно використовується в графі візуального відтінку.
...
Постійна :ref:`Vector2<class_Vector2>`, яка може використовуватися як вхідний вузол.
...
A :ref:`Vector2<class_Vector2>` постійний, що представляє стан даного вузла.
