...
Для тіла, яке завжди заморожене, використовуйте :ref:`StaticBody3D<class_StaticBody3D>` або :ref:`AnimatableBody3D<class_AnimatableBody3D>`.
...
Режим заморожування тіла. Можна використовувати для встановлення поведінки тіла, коли ввімкнено :ref:`freeze<class_RigidBody3D_property_freeze>`.
