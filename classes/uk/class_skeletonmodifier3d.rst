...
Викликається, коли потрібно перевірити назву та індекс кістки, наприклад, час входу в дерево або зміну скелета.
...
Отримати батьківський вузол :ref:`Skeleton3D<class_Skeleton3D>`, якщо знайдено.
