...
**Translation** - ресурси, які можуть бути завантажені та розвантажені на вимогу. Вони малюють збір рядків до їх індивідуальних перекладів, а також забезпечують зручні методи оформлення.
...
Додає повідомлення з перекладом у множині, якщо він відсутній, а потім його переклад.
...
Повернення всіх повідомлень (під ключів).
...
Повертаємо всі повідомлення (перекладений текст).
