...
Контроль інтерфейсу, що відображає :ref:`StyleBox<class_StyleBox>`.
...
**Panel** - це контроль GUI, який відображає :ref:`StyleBox<class_StyleBox>`. Дивитися також :ref:`PanelContainer<class_PanelContainer>`.
...
- `Hierarchical Finite State Machine Демо <https://godotengine.org/asset-library/asset/2714>`__
...
:ref:`StyleBox<class_StyleBox>` цього контролю.
