...
З метою створення `Obfuscator <https://developer.android.com/google/play/licensing/adding-licensing#impl-Obfuscator>`__.
...
Колір фону, який використовується для кореневого вікна. За замовчуванням ``black``.
