...
Сфероїдно-подібний приваблювач, який впливає на частинки з вершин :ref:`GPUParticles3D<class_GPUParticles3D>`.
...
Сфероїдно-подібний приваблювач, який впливає на частинки з вершин :ref:`GPUParticles3D<class_GPUParticles3D>`. Чи можна використовувати для залучення частинок до його походження, або відштовхувати їх від його походження.
...
\ **Примітка:** Привабливі частини тільки впливають :ref:`GPUParticles3D<class_GPUParticles3D>`, не :ref:`CPUParticles3D<class_CPUParticles3D>`.
...
Привабливий радіус сфери в 3D одиниці.

\ **Примітка:** Розтягнуті еліпси можуть бути отримані за допомогою неоднорідного масштабування на **GPUParticlesAttractorSphere3D**.
