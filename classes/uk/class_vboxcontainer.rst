...
Варіант :ref:`BoxContainer<class_BoxContainer>`, який може тільки влаштувати свій контроль дитини вертикально. Контроль дітей автоматично перераховуються при зміні мінімального розміру.
