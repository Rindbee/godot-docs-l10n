...
Імпортовані сцени можна автоматично змінювати одразу після імпорту, установивши для їхньої властивості **Custom Script** Import у сценарій ``instrument``, який успадковує цей клас. 
