...
Додає режекторний фільтр до звукової шини.
...
Послаблює частоти у вузькій смузі навколо :ref:`AudioEffectFilter.cutoff_hz<class_AudioEffectFilter_property_cutoff_hz>` і обрізає частоти за межами цього діапазону.
