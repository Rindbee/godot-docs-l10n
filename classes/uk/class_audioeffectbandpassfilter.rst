...
Послаблює частоти всередині діапазону навколо :ref:`AudioEffectFilter.cutoff_hz<class_AudioEffectFilter_property_cutoff_hz>` і обрізає частоти за межами цього діапазону.
