...
:ref:`Shape3D<class_Shape3D>` є :ref:`WorldBoundaryShape3D<class_WorldBoundaryShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`SeparationRayShape3D<class_SeparationRayShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є ``СфераShape3D``.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`BoxShape3D<class_BoxShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`CapsuleShape3D<class_CapsuleShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`CylinderShape3D<class_CylinderShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`ConvexPolygonShape3D<class_ConvexPolygonShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`ConcavePolygonShape3D<class_ConcavePolygonShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` є :ref:`HeightMapShape3D<class_HeightMapShape3D>`.
...
:ref:`Shape3D<class_Shape3D>` використовується внутрішньо для м'якого тіла. Будь-яка спроба створити цей вид результатів форми в похибці.
...
Встановлює дані фігури, які визначають її форму та розмір. Дані, що передаються, залежать від типу створеної фігури :ref:`shape_get_type()<class_PhysicsServer3D_method_shape_get_type>`.
