...
Вузол анімації масштабування за часом, що використовується в :ref:`AnimationTree<class_AnimationTree>`.
...
Дозволяє масштабувати швидкість анімації (або перевернути її) в будь-якій дитині :ref:`AnimationNode<class_AnimationNode>`\ s. Налаштування його до ``0.0`` буде призупинити анімацію.
