...
Повертає 64-бітне число з плаваючою комою за заданим ``index`` у масиві. Якщо ``index`` виходить за межі або є від'ємним, цей метод завершується невдачею та повертає ``0.0``.
