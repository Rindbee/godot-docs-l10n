...
Розмір площі, покритого **VoxelGI**. Якщо ви робите розмір більшим, не збільшуючи підрозділи з :ref:`subdiv<class_VoxelGI_property_subdiv>`, розмір кожної комірки збільшиться і призведе до більш детального освітлення.

\ **Примітка:** Розмір затискається до 1,0 одиниці або більше на кожній осі.
