...
Перетворює число із західної арабської системи числення (0..9) у систему числення, що використовується в ``language``.
...
Повертає рядок, перетворений на нижній регістр.
...
Повертає рядок, перетворений на регістр літер у заголовку.
...
Повертає рядок, перетворений на верхній регістр.
