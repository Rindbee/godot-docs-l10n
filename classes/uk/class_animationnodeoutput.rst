...
Вузол виведення анімації :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>`.
...
Вузол, створений автоматично в :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>`, який виводить остаточну анімацію.
