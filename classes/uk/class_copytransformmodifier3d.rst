...
Застосуйте скопійоване перетворення набору кісток за допомогою методу ``BoneConstraint3D.set_reference_bone`` до набору кісток за допомогою методу :ref:`BoneConstraint3D.set_apply_bone()<class_BoneConstraint3D_method_set_apply_bone>` з обробкою його деякими масками та опціями.
