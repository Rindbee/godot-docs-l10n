...
Аудіоефект, який можна використовувати для регулювання інтенсивності стерео панорамування.
...
Посилює різницю між стереоканалами, збільшуючи або зменшуючи наявне панорамування. Значення 0,0 зменшить стерео до моно. Не впливає на моно сигнал.
...
Розширює звукову сцену за допомогою фазового зсуву в поєднанні з :ref:`time_pullout_ms<class_AudioEffectStereoEnhance_property_time_pullout_ms>`. Просто панорамує звук до лівого каналу, якщо :ref:`time_pullout_ms<class_AudioEffectStereoEnhance_property_time_pullout_ms>` дорівнює 0.
...
Розширює звукову сцену завдяки фазовому зсуву в поєднанні з :ref:`surround<class_AudioEffectStereoEnhance_property_surround>`. Просто затримує правий канал, якщо :ref:`surround<class_AudioEffectStereoEnhance_property_surround>` дорівнює 0.
