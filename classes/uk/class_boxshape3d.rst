...
Тривимірна форма коробки, яка використовується для фізичного зіткнення.
...
Тривимірна форма коробки, призначена для використання у фізиці. Зазвичай використовується для надання форми для :ref:`CollisionShape3D<class_CollisionShape3D>`.

\ **Продуктивність: ** **BoxShape3D** швидко перевіряє зіткнення. Це швидше, ніж :ref:`CapsuleShape3D<class_CapsuleShape3D>` і :ref:`CylinderShape3D<class_CylinderShape3D>`, але повільніше, ніж :ref:`SphereShape3D<class_SphereShape3D>`.
