...
Контроль, що відображає суцільний колір прямокутника.
...
Відображає прямокутник, заповнений суцільним :ref:`color<class_ColorRect_property_color>`. Якщо вам потрібно відобразити лише межу, розгляньте можливість використання :ref:`Panel<class_Panel>`.
