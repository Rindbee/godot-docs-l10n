...
Voir aussi :ref:`OS.get_locale()<class_OS_method_get_locale>` et :ref:`OS.get_locale_language()<class_OS_method_get_locale_language>` pour récupérer le langage du système de l'utilisateur.
...
Renvoie la langue de la locale et sa variation (ex. ``"fr_FR"`` renverra ``"Français (France)"``).
...
**Obsolète :** Use :ref:`find_translations()<class_TranslationServer_method_find_translations>` instead.
