...
Un paramètre :ref:`Vector3<class_Vector3>` à utiliser dans le graphe de shader visuel.
...
Sera traduit en ``uniform vec3`` dans le code du shader.
...
Active l'utilisation de :ref:`default_value<class_VisualShaderNodeVec3Parameter_property_default_value>`.
