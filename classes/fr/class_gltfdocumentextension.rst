...
**Hérité de:** :ref:`GLTFDocumentExtensionConvertImporterMesh<class_GLTFDocumentExtensionConvertImporterMesh>`
...
Étend la fonctionnalité de la classe :ref:`GLTFDocument<class_GLTFDocument>` en vous permettant d'exécuter du code arbitraire à différentes étapes de l'importation ou de l'exportation du glTF.

Pour l'utiliser, faites une nouvelle classe étendant GLTFDocumentExtension, redéfinissez toutes les méthodes dont vous avez besoin, faites une instance de votre classe, et enregistrez la en utilisant :ref:`GLTFDocument.register_gltf_document_extension()<class_GLTFDocument_method_register_gltf_document_extension>`.
