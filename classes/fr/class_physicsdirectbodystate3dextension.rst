...
**Hérite de :** :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` **<** :ref:`Object<class_Object>`

Fournit des méthodes virtuelles qui peuvent être redéfinies pour créer des implémentations personnalisées de :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>`.
...
Cette classe étend :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` en fournissant des méthodes virtuelles supplémentaires qui peuvent être redéfinies. Lorsque ces méthodes sont redéfinies, elles seront appelées au lieu des méthodes internes du serveur de physique.

Destiné à être utilisée avec GDExtension pour créer des implémentations personnalisées de :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>`.
