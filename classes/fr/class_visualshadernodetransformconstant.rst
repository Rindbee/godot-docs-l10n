...
Une constante :ref:`Transform3D<class_Transform3D>` à utiliser dans le graphe de shader visuel.
...
Une constante :ref:`Transform3D<class_Transform3D>`, qui peut être utilisée comme nœud d’entrée.
...
Une constante :ref:`Transform3D<class_Transform3D>` qui représente l'état de ce nœud.
