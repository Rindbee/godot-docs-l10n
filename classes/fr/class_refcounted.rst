...
Initialise le compteur de référence interne. Utilisez ceci seulement si vous savez vraiment ce que vous faites.
...
Augmente le compteur de référence interne. Utilisez ceci seulement si vous savez vraiment ce que vous faites.

Renvoie ``true`` si l'augmentation a réussi, ``false`` sinon.
