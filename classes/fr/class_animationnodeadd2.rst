...
Mélange deux animations additivement à l'intérieur d'un :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>`.
...
Une ressource à ajouter à un :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>`. Mélange deux animations de manière additive selon la quantité de valeur.
