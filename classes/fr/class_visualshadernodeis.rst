...
Renvoie le résultat booléen de la comparaison entre ``INF`` (l'infini) ``NaN`` (n'est pas un nombre) et un paramètre scalaire.
...
Représente la taille de l'énumération :ref:`Function<enum_VisualShaderNodeIs_Function>`.
