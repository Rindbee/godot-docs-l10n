...
Renvoie ``true`` lorsque le polygone de navigation fourni est en cours de pré-calcul sur un thread d'arrière-plan.
...
Renvoie la marge de raccordement du bord de la carte. La marge de raccordement est une distance utilisée pour relier deux régions.
...
Crée un nouvel obstacle de navigation.
...
Définit le ``navigation_polygon`` pour la région.
