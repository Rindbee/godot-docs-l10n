...
Un :ref:`Vector3<class_Vector3>` constant à utiliser dans le graphe de shader visuel.
...
Un :ref:`Vector3<class_Vector3>` constant, qui peut être utilisé comme un nœud d'entrée.
