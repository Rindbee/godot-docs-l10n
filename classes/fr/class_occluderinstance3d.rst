...
Renvoie si la couche spécifiée de :ref:`bake_mask<class_OccluderInstance3D_property_bake_mask>` est activée, selon un ``layer_number`` entre 1 et 32.
...
Selon ``value``, active ou désactive la couche spécifiée dans le :ref:`bake_mask<class_OccluderInstance3D_property_bake_mask>`, selon un ``layer_number`` entre 1 et 32.
