...
Un nœud d'animation qui étire le temps utilisé dans :ref:`AnimationTree<class_AnimationTree>`.
...
Permet de redimensionner la vitesse de l'animation (ou de l'inverser) dans tout enfant :ref:`AnimationNode<class_AnimationNode>`\ s. La définir à ``0.0`` va mettre en pause l'animation.
