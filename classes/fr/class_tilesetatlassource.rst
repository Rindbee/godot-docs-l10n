...
**Hérite de :** :ref:`TileSetSource<class_TileSetSource>` **<** :ref:`Resource<class_Resource>` **<** :ref:`RefCounted<class_RefCounted>` **<** :ref:`Object<class_Object>`
...
Représente la taille de l'énumération :ref:`TileAnimationMode<enum_TileSetAtlasSource_TileAnimationMode>`.
...
Renvoie la somme des durées des trames de la tuile aux coordonnées ``atlas_coords``. Cette valeur doit être divisée par la vitesse d'animation pour obtenir la durée réelle de la boucle d'animation.
