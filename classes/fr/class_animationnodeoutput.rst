...
Le nœud d’animation de sortie d’un :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>`.
...
Un nœud créé automatiquement dans un :ref:`AnimationNodeBlendTree<class_AnimationNodeBlendTree>` qui produit l'animation finale.
