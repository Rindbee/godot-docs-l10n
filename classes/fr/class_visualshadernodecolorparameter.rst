...
Un paramètre :ref:`Color<class_Color>` à utiliser dans le graphe de shader visuel.
...
Sera traduit en ``uniform vec4`` dans le code du shader.
...
Active l'utilisation de :ref:`default_value<class_VisualShaderNodeColorParameter_property_default_value>`.
