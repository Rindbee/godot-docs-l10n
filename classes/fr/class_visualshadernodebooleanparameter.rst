...
Un paramètre booléen à utiliser dans le graphe de shader visuel.
...
Sera traduit en ``uniform bool`` dans le code du shader.
...
Active l'utilisation de :ref:`default_value<class_VisualShaderNodeBooleanParameter_property_default_value>`.
