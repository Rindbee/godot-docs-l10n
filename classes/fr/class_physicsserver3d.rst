...
La :ref:`Shape3D<class_Shape3D>` est une :ref:`WorldBoundaryShape3D<class_WorldBoundaryShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est une :ref:`SeparationRayShape3D<class_SeparationRayShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est une :ref:`SphereShape3D<class_SphereShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est une :ref:`BoxShape3D<class_BoxShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est une :ref:`CapsuleShape3D<class_CapsuleShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est un :ref:`CylinderShape3D<class_CylinderShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est un :ref:`ConvexPolygonShape3D<class_ConvexPolygonShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est un :ref:`ConcavePolygonShape3D<class_ConcavePolygonShape3D>`.
...
La :ref:`Shape3D<class_Shape3D>` est une :ref:`HeightMapShape3D<class_HeightMapShape3D>`.
...
Définit les données de forme qui définissent sa forme et sa taille. Les données à transmettre dépendent du type de forme créé (voir :ref:`shape_get_type()<class_PhysicsServer3D_method_shape_get_type>`).
